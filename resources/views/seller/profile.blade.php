...
<div class="container">
    <div class="page-header">
        <h1>My Profile</h1>
        <p>Update your seller information</p>
    </div>
        ...
        <form action="{{ route('seller.profile.update') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="business_name" name="business_name" value="{{ old('business_name', $profile->business_name) }}" placeholder="e.g., Juan's Rice Trading">
                    @error('business_name')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="bio" name="bio" rows="3" placeholder="Tell buyers about your rice business...">{{ old('bio', $profile->bio) }}</textarea>
                    @error('bio')
                        <span class="error">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <div class="stat-value">{{ number_format($profile->rating ?? 0, 1) }}</div>
